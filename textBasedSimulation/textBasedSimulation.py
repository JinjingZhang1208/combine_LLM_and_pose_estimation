...
def startConversation(userName):
    ...
    while True:
        ...
        endTime=time.time()
        print(f"Time taken for the conversation generation by GPT : {endTime-startTime:.2f}")
        print(f"{userName} : {finalStatement}")
        ...
        endTime=time.time()
        print(f"Time taken for the observation generation by GPT : {endTime-startTime:.2f} ")
